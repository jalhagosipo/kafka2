...
public class ExactlyOnceProducer {
    public static void main(String[] args) {
        ...
        props.setProperty(ProducerConfig.TRANSACTIONAL_ID_CONFIG, "transaction-01"); // 정확히 한번 전송을 위한 설정
        ...
        try {
            for (int i = 0; i < 1; i++) {
                ProducerRecord<String, String> record = new ProducerRecord<>("test05", "Apache Kafka is a distributed streaming platform - " + i);
